...
exports.PerformerModule = PerformerModule = __decorate([
    (0, common_1.Module)({
        imports: [
            typeorm_1.TypeOrmModule.forFeature([performer_entity_1.PerformerEntity]),
        ...
        exports: [typeorm_1.TypeOrmModule.forFeature([performer_entity_1.PerformerEntity]), performer_service_1.PerformerService]
    })
], PerformerModule);
